...
export class ContextMenuService implements IContextMenuService {
    ...
    protected createMenu(items: MenuItem[], closeCallback: () => void): HTMLDivElement {
        ...
        menuNode.id = '<%= language-id %>-context-menu';
        menuNode.classList.add('<%= language-id %>-context-menu');
    ...
    protected createMenuItems(items: MenuItem[], menuNode: HTMLDivElement, closeCallback: () => void) {
        items.forEach((item, index) => {
            ...
            menuItem.id = '<%= language-id %>-context-menu-item-' + index;
            menuItem.classList.add('<%= language-id %>-context-menu-item');
