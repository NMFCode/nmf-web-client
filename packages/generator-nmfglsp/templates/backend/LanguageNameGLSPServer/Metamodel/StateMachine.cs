...
namespace <%= LanguageName %>.FiniteStateMachines
{
    ...
    public partial class StateMachine : ModelElement, IStateMachine, IModelElement
    {
        ...
        {
            return ((ITypedElement)(((ModelElement)(StateMachines.FiniteStateMachines.StateMachine.ClassInstance)).Resolve("name")));
        }
        
        private static ITypedElement RetrieveStatesReference()
        {
            return ((ITypedElement)(((ModelElement)(StateMachines.FiniteStateMachines.StateMachine.ClassInstance)).Resolve("states")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(StateMachines.FiniteStateMachines.StateMachine.ClassInstance)).Resolve("startState")));
        }
