...
namespace <%= LanguageName %>.FiniteStateMachines
{
    ...
    public partial class State : ModelElement, IState, IModelElement
    {
        ...
        {
            return ((ITypedElement)(((ModelElement)(StateMachines.FiniteStateMachines.State.ClassInstance)).Resolve("name")));
        }
        
        private static ITypedElement RetrieveOutgoingReference()
        {
            return ((ITypedElement)(((ModelElement)(StateMachines.FiniteStateMachines.State.ClassInstance)).Resolve("outgoing")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(StateMachines.FiniteStateMachines.State.ClassInstance)).Resolve("incoming")));
        }
