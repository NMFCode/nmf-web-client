...
namespace <%= LanguageName %>.FiniteStateMachines
{
    ...
    public partial class Transition : ModelElement, ITransition, IModelElement
    {
        ...
        {
            return ((ITypedElement)(((ModelElement)(StateMachines.FiniteStateMachines.Transition.ClassInstance)).Resolve("trigger")));
        }
        
        private static ITypedElement RetrieveSourceReference()
        {
            return ((ITypedElement)(((ModelElement)(StateMachines.FiniteStateMachines.Transition.ClassInstance)).Resolve("source")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(StateMachines.FiniteStateMachines.Transition.ClassInstance)).Resolve("target")));
        }
